...
@ViewScoped
@ManagedBean(name="editarCidadaoBean")
public class EditarCidadaoBean extends AbstractBean implements Serializable {
	...
	public void init() {
		try {
			...
			id = Integer.valueOf(params.get("idCidadao"));
